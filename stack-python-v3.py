# -*- coding: utf-8 -*-
# source activate /home/kelton/anaconda2/envs/my_env
...
# STACKING
stack = StackingClassifier(classifiers=[clf1, clf2], meta_classifier=clf2)
stack_pred = cross_val_predict(stack, X, y, cv=10)
conf_stack = confusion_matrix(y, stack_pred)

print("********* Desempenho Stacking **********")
print("Acuracia:", accuracy_score(y, stack_pred)*100)
print("AUC:", roc_auc_score(y, stack_pred)*100)
print("Precision:", precision_score(y, stack_pred)*100)
print("Recall:", recall_score(y, stack_pred)*100)
print("F1P:", f1_score(y, stack_pred)*100)
...
for ii in range(0,int(combinacoes.size/2)):
    a=combinacoes[ii,0]
    b=combinacoes[ii,1]
    print("agreementMatrix(%s, %s, y)" % (a, b))
